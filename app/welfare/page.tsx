...
const services = [
  ...
  ["02", "文化推廣", "以課程、藝術與分享，讓覺察成為人人可親近的生活文化。", "/images/garden-meditation.jpg"],
  ["03", "社會關懷", "走進需要陪伴的地方，讓理解與尊重成為關係的起點。", "/images/teaching.jpg"],
];
...
export default function WelfarePage() {
  return (
    <main>
      <SiteHeader />
      <PageHero eyebrow="PUBLIC WELFARE · 公益與服務" title="讓內在的改變，成為照亮他人的行動。" description="以志工服務、文化推廣與社會關懷，回應真實的社會需要。" image="/images/wildflowers.jpg" />
